...
One misc useful function is recompile my org file so that its
startup is alot faster. This does tangle and byte compile.
...
#+BEGIN_SRC emacs-lisp
  (defun my/config-reload ()
    "Reload the config. "
    (interactive)
    (org-babel-tangle-file "~/Dotfiles/.emacs.d/config.org")
    (byte-compile-file "~/Dotfiles/.emacs.d/config.el"))
#+END_SRC
