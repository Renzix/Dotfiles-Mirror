...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"   }, "[",
        function ()
            local t1 = awful.screen.focused().selected_tags
            local t2 = awful.screen.focused().get_next_in_direction("left").selected_tags
            t1:swap(t2)
        end,
        {description = "Swaps the tag to the previous screen", group = "screen"}),
    awful.key({ modkey, "Control"   }, "]",
        function ()
            local t2 = awful.screen.focused().get_next_in_direction("right").selected_tags
            local t1 = awful.screen.focused().selected_tags
            t1:swap(t2)
        end,
        {description = "Swaps the tag to the next screen", group = "screen"}),
...
-- This should map on the top row of your keyboard, usually 1 to 3.
for i = 1, 9 do
...
awful.spawn("feh --bg-scale \"/home/genzix/Media/wallpaper.jpg\"")
