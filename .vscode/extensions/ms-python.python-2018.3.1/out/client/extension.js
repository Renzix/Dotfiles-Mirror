...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vscode_1.languages.setLanguageConfiguration(PYTHON.language, {
            onEnterRules: [
                {
        ...
        context.subscriptions.push(vscode_1.languages.registerRenameProvider(PYTHON, new renameProvider_1.PythonRenameProvider(serviceContainer)));
        const definitionProvider = new definitionProvider_1.PythonDefinitionProvider(jediFactory);
        context.subscriptions.push(vscode_1.languages.registerDefinitionProvider(PYTHON, definitionProvider));
        context.subscriptions.push(vscode_1.languages.registerHoverProvider(PYTHON, new hoverProvider_1.PythonHoverProvider(jediFactory)));
        context.subscriptions.push(vscode_1.languages.registerReferenceProvider(PYTHON, new referenceProvider_1.PythonReferenceProvider(jediFactory)));
        context.subscriptions.push(vscode_1.languages.registerCompletionItemProvider(PYTHON, new completionProvider_1.PythonCompletionItemProvider(jediFactory, serviceContainer), '.'));
        context.subscriptions.push(vscode_1.languages.registerCodeLensProvider(PYTHON, serviceContainer.get(contracts_1.IShebangCodeLensProvider)));
        const symbolProvider = new symbolProvider_1.PythonSymbolProvider(jediFactory);
        context.subscriptions.push(vscode_1.languages.registerDocumentSymbolProvider(PYTHON, symbolProvider));
        if (pythonSettings.devOptions.indexOf('DISABLE_SIGNATURE') === -1) {
            context.subscriptions.push(vscode_1.languages.registerSignatureHelpProvider(PYTHON, new signatureProvider_1.PythonSignatureProvider(jediFactory), '(', ','));
        }
        if (pythonSettings.formatting.provider !== 'none') {
            ...
            context.subscriptions.push(vscode_1.languages.registerDocumentFormattingEditProvider(PYTHON, formatProvider));
            context.subscriptions.push(vscode_1.languages.registerDocumentRangeFormattingEditProvider(PYTHON, formatProvider));
        }
        ...
        context.subscriptions.push(vscode_1.languages.registerOnTypeFormattingEditProvider(PYTHON, new blockFormatProvider_1.BlockFormatProviders(), ':'));
        context.subscriptions.push(vscode_1.languages.registerOnTypeFormattingEditProvider(PYTHON, new onEnterFormatter_1.OnEnterFormatter(), '\n'));
