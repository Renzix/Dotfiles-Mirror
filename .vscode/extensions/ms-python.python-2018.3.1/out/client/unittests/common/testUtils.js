...
function displayTestErrorMessage(message) {
    vscode_1.window.showErrorMessage(message, constants.Button_Text_Tests_View_Output).then(action => {
        if (action === constants.Button_Text_Tests_View_Output) {
            vscode_1.commands.executeCommand(constants.Commands.Tests_ViewOutput, undefined, constants_1.CommandSource.ui);
        }
    });
}
