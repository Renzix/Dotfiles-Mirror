...
<<<<<<< HEAD
	  ...
	  (general-define-key
	   ...
	   (kbd "'") 'eshell
	   (kbd "\"") 'term
	   (kbd "c") (lambda() (interactive) (let ((default-directory (concat HOME "/Dotfiles"))(magit-pull-from-upstream "master")) (find-file (concat HOME "/.emacs.d/settings.org"))))
...
=======
     ...
     (evil-define-key 'normal global-map (kbd ";") 'helm-M-x)
     (evil-define-key 'emacs global-map (kbd "ESC") 'evil-god-state-normal) 
...
>>>>>>> 3ecc5b3e9060b4a5b5029a8f8f9230a284b57d02
   #+END_SRC
* Programming
** Projectile
   #+BEGIN_SRC emacs-lisp
