...
** Evil-Movement-State
   ...
   #+BEGIN_SRC emacs-lisp :exports none
     ...
     (evil-define-state movement
       ...
       :exit-hook (evil-movement-stop-hook)
        (evil-define-key 'movement global-map 
          (kbd "q") 'delete-window
          (kbd "Q") 'kill-emacs
     ...
     (defun evil-movement-stop-hook ()
       ;; Exit window-mode-map
       (message "Exiting movement mode"))
   #+END_SRC
** Keybindings
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (evil-define-key 'movement global-map (kbd "ESC") 'normal-mode)
     (evil-define-key 'movement global-map (kbd ":") 'evil-command-window-mode)
     (evil-define-key 'normal global-map (kbd "\\") 'evil-movement-state)
