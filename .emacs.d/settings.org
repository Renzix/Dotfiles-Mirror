...
** EXWM
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (if (boundp 'WM) (progn
			...
			(require 'exwm-randr)
			(setq exwm-randr-workspace-output-plist '(1 "DVI-D-0" 2 "DP-3" 3 "DP-4"))
			(add-hook 'exwm-randr-screen-change-hook
				  (lambda() 
				    (start-process-shell-command
				     "xrandr" nil "xrandr --output DVI-D-0 --left-of DP-3 --auto")
				    (start-process-shell-command
				     "xrandr" nil "xrandr --output DP-3 --left-of DP-4 --auto")))
			(exwm-randr-enable)))
...
** Keybindings
   #+BEGIN_SRC emacs-lisp
     ...
     (evil-ex-define-cmd "ee" 'helm-find-files)
     ;; Some other keybinds 
     ;; Kill-buffer C-x k
     (general-define-key
      :states 'normal
