...
** Movement-State
   ...
   all normal states keys. This makes it really annoying so i made a
   new state called movement state. Its basically a extra command
   state which i want to eventually activate on all buffers with a
   toggle and have a single way to run it
   #+BEGIN_SRC emacs-lisp
     (general-define-key 
	...
	(kbd "'") 'eshell
	(kbd "\"") 'vterm
	(kbd "m") 'helm-system-packages
	(kbd "g g") 'magit-status
	(kbd "g s") 'magit-stash-popup
	(kbd "g p") 'magit-pull-popup
	(kbd "g P") 'magit-push-popup
	(kbd "g C") 'magit-clone
	(kbd "g c") 'magit-commit-popup
	(kbd "g b") 'magit-branch-popup
	(kbd "p") 'projectiile-command-map))
	...
	(t
     ...
     (general-define-key
      :states '(movement)
      :prefix "c"
      (kbd "c") (lambda() (interactive) (find-file (concat HOME "/.emacs.d/settings.org")))
      ...
      (kbd "d") (lambda() (interactive) (find-file "/sudo::/etc/portage/savedconfig/x11-wm/dwm-6.1-r1.h")))
...
** Keybindings
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (evil-define-key '(normal insert motion visual) global-map (kbd "M-b") 'evil-buffer-list)
...
** IRC/Circe
   #+BEGIN_SRC emacs-lisp
     ...
     (setq circe-reduce-lurker-spam t
	   ...
	   '(("Freenode"
	      :nick "Renzix"
	      :channels (:after-auth "#emacs" "#emacs-circe" "#unixporn" "#gentoo")
