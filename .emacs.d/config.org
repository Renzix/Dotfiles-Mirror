...
*** god mode
    ...
    G prefix its the same as Control and Alt.
...
** Emacs State
   ...
   #+BEGIN_SRC emacs-lisp :tangle no
     (general-define-key
      :keymaps '(global evil-emacs-state-map override)
      "M-x" 'helm-M-x
      ...
      "C-\"" 'my/helm-projectile-search-or-project
...
**** Org mode
     ...
     #+BEGIN_SRC emacs-lisp :tangle no
       ...
       (general-define-key
        :keymaps 'org-mode-map
        "C-c r" 'helm-org-rifle) ; There prob is a better way to do this i might make my own macro
     #+END_SRC
