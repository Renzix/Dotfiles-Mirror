...
(general-define-key
 ...
 (kbd "w j") 'windmove-down; @key-window
 (kbd "w k") 'windmove-up
 ...
 (kbd "f f") 'helm-find-files ;@key-file
 (kbd "f S") 'sudo-edit
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (general evil-magit which-key helm-descbinds org-pdfview magit helm-make cargo helm-ag-r helm-ag helm-projectile web-mode linum-relative company-emacs-eclim company-anaconda restart-emacs helm-tramp python-mode company-c-headers helm-company company-racer auto-complete autopair apropospriate-theme company-lsp racer rust-mode zenburn-theme helm use-package evil-visual-mark-mode))))
(custom-set-faces
